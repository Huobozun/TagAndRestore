        ...
        for j in range(0,len(searchlabel)):
            ...
            for i in range(0,len(tokenstr)):
                ...
                if(tokenstr[i]==searchlabel[j]):
                    number1+=1
                    str1=(end_index-len(lines[i]),tokenstrhuanyuan[i])#记录文中位置和文中匹配词
                    local0.append(str1)
        ...
        if(q==1):
            ...
            for i in range(0,len(lines)):
                ...
                if(lines[i]==searchlabel[len(searchlabel)-2]):
                    number1+=1
                    str1=(end_index-len(lines[i]),lines[i])#记录文中位置和文中匹配词
                    local0.append(str1)
            #比对去除缩写后的标签个数
            stokenstr=[]
            ...
            for i in range(0,len(stokenstr)):
                ...
                if(stokenstr[i]==searchlabel[len(searchlabel)-1]):
                    number1+=1
                    str1=(end_index-len(lines[i]),stokenstrhuanyuan[i])#记录文中位置和文中匹配词
                    local0.append(str1)
        #print(local0)
